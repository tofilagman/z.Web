...
using System.Net;
using z.Web.Downloader.Concurrency;
using z.Web.Properties;
using z.Web;
...
namespace z.Web.Downloader
{
    ...
    public class Downloader
    {
        ...
        private System.Timers.Timer tmrStatus;
        ...
        public event EventHandler<ProgressEventArgs> ProgressChange;
        ...
        private void AllocLocalFile()
        {
            ...
            if (fileInfo.Exists)
            {
                ...
                do
                {
                    newFileName = fileInfo.DirectoryName.GetWithBackslash() //PathHelper.GetWithBackslash(fileInfo.DirectoryName)
        ...
        {
            tmrStatus = new System.Timers.Timer();
            tmrStatus.Interval = 1000;
            tmrStatus.Elapsed += (a, b) =>
            {
                if (progressValue != Convert.ToInt32(Math.Floor(Progress)))
                {
                    progressValue = Convert.ToInt32(Math.Floor(Progress));
                    if (ProgressChange != null)
                        ProgressChange(this, new ProgressEventArgs()
                        {
